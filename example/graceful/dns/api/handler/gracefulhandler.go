...
import (
	...
	"github.com/gofaith/go-zero/example/graceful/dns/api/svc"
	"github.com/gofaith/go-zero/example/graceful/dns/api/types"
	"github.com/gofaith/go-zero/example/graceful/dns/rpc/graceful"
